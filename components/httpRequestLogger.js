...
function HttpRequestLogger() {
	...
	observerService.addObserver(httpRequestLogger, "http-on-examine-response", false);
	observerService.addObserver(httpRequestLogger, "http-on-examine-cached-response", false);
}
